...
export const FAQS = [
	{
		id: 1,
		header: 'What is Mflix?',
		body:
			"Mflix is a streaming service that offers a wide variety of award-winning TV shows, movies, anime, documentaries and more on thousands of internet-connected devices.\n\nYou can watch as much as you want, whenever you want, without a single commercial – all for one low monthly price. There's always something new to discover, and new TV shows and movies are added every week!"
	},
	{
		id: 2,
		header: 'How much does Mflix cost?',
		body:
			'Watch Mflix on your smartphone, tablet, Smart TV, laptop or streaming device, all for one fixed monthly fee. Plans range from ₱149 to ₱549 a month. No extra costs, no contracts.'
	},
	{
		id: 3,
		header: 'Where can I watch?',
		body:
			"Watch anywhere, anytime, on an unlimited number of devices. Sign in with your Mflix account to watch instantly on the web at mflix.com from your personal computer or on any internet-connected device that offers the Mflix app, including smart TVs, smartphones, tablets, streaming media players and game consoles.\n\nYou can also download your favourite shows with the iOS, Android, or Windows 10 app. Use downloads to watch while you're on the go and without an internet connection. Take Mflix with you anywhere."
	},
	{
		id: 4,
		header: 'How do I cancel?',
		body:
			'Mflix is flexible. There are no pesky contracts and no commitments. You can easily cancel your account online in two clicks. There are no cancellation fees – start or stop your account anytime.'
	},
	{
		id: 5,
		header: 'What can I watch on Mflix?',
		body:
			'Mflix has an extensive library of feature films, documentaries, TV shows, anime, award-winning Mflix originals, and more. Watch as much as you want, any time you want.'
	}
];
...
export const FEATURES = [
	...
	},
	{
		...
		alt: 'Mflix on different devices'
	}
];
...
export const FOOTER_LINKS = [
	...
	{ id: 17, text: 'Mflix Originals', url: 'https://www.netflix.com/ph/browse/genre/839338' }
];
